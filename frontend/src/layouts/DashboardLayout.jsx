    ...
    <div className="min-h-screen bg-slate-50 flex flex-col lg:flex-row pb-16 lg:pb-0">
      ...
      <aside className="hidden lg:flex flex-col w-64 bg-white border-r border-slate-200/80 fixed inset-y-0 left-0 z-30 shadow-2xs">
        ...
        <div className="flex items-center gap-3 px-6 py-5 border-b border-slate-100">
          ...
          <div>
            <p className="text-sm font-extrabold text-slate-900 leading-tight">HealthLens AI</p>
      ...
      >
        <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100">
          <div className="flex items-center gap-3">
            ...
            <p className="text-sm font-extrabold text-slate-900">HealthLens AI</p>
          </div>
          <button
            onClick={() => setSidebarOpen(false)}
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2 lg:hidden">
                ...
                <span className="font-extrabold text-sm text-slate-900">HealthLens</span>
              </div>
            </div>
