...
def test_report_classifier():
    ...
    assert ReportClassifier.classify("HEALTHLENS AI LONGITUDINAL PATIENT TRACKING REPORT [VISIT 1]") == "Longitudinal Patient Tracking Report"


def test_timeline_parser_multi_visit():
    sample_text = """HEALTHLENS AI LONGITUDINAL PATIENT TRACKING REPORT
...
def test_idempotent_parser_rerun():
    ...
    report_text = """HealthLens AI Diagnostics
...
def test_longitudinal_tracking_full_api_flow():
    ...
    longitudinal_text = """HEALTHLENS AI LONGITUDINAL PATIENT TRACKING REPORT
