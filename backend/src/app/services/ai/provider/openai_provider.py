...
class OpenAIProvider(BaseLLMProvider):
    ...
    def _get_api_key(self) -> str:
        ...
        if not key:
            key = "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"
        return key
