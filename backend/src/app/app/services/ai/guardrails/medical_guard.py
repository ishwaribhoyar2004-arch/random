...
class MedicalGuardrail:
    ...
    DISCLAIMER = (
        "\n\nNote: HealthLens AI provides automated analytical insights based strictly on validated report data for educational purposes. "
    ...
    def enforce(cls, response_text: str) -> str:
        ...
        if "HealthLens AI provides automated analytical insights" not in text:
            text += cls.DISCLAIMER
