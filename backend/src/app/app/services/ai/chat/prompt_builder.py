...
class PromptBuilder:
    ...
    STRICT_SYSTEM_DIRECTIVES = (
        "You are HealthLens AI, a specialized medical report explanation layer.\n\n"
        ...
        "'I am HealthLens AI, a specialized medical report assistant. I can only assist with questions directly related to your medical lab reports, clinical parameters, and health insights.'"
    )
